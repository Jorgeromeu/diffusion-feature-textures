...
class BadPosesExperimentConfig:
    ...
    run: RunConfig
    prompt: str
    good_animation: AnimationConfig
    bad_pose: str
    save_tensors: GrSaveConfig
    generative_rendering: GenerativeRenderingConfig


class BadPosePollutionExperiment(WandbExperiment):
    experiment_name = "bad_poses_pollution"
    ...
    def run_configs(self):
        ...
        with initialize(version_base=None, config_path="../../config"):
            config: BadPosePollutionExperiment = compose(
